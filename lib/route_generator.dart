...
import 'package:time_pe/screens/electricity/view2.dart';
...
return [
      ...
      GetPage(
          name: "/verificationSuccessfull", page: () => const VerificationSuccessfull()),
      GetPage(name: "/verificationToDashboard", page: () => const VerificationToDashboard()),
      GetPage(name: "/transferSucessfull", page: () {return const TransferSucessfull();}),
      GetPage(name: "/transferSucessfullView", page: () => const TransferSucessfullView()),
      ...
      GetPage(name: "/successfullSubmitted", page: () => const SuccessfullSubmitted()),
      ...
      GetPage(name: "/faceAuthentication", page: () => const FaceAuthentication()),
